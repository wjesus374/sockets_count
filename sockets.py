...
#Zabbix Server's
zabbix = [{"zabbixserver": "127.0.0.1", "zabbixport": "10051"}]

#Dict com cliente, chave da estatistica e item do Zabbix (para envio via Zabbix Sender)
filterdata = [  {"cliente": "HOST1", "porta": 12345, "zabbix_item": "sockets[12345]"},
                {"cliente": "HOST1", "porta": 12346, "zabbix_item": "sockets[12346]"}]

#Server ncat --broker --listen -p 12345
#Client nc -v 127.0.0.1 12345

#Especificar algumas portas
filterports = "1234*|80|443"
#Todas as portas
#filterports = ".*"
...
#maxBytes=20MBytes
fh = logging.handlers.RotatingFileHandler('/tmp/sockets.log', maxBytes=20971520, backupCount=5)
...
if __name__ == "__main__":
    ...
    if sys.argv[1] == "discovery":
        data = readconf("/tmp/sockets.json")
    ...
    if sys.argv[1] == "create":
        ...
        for key,value in search.items():
            ...
            data["{#PORTA}"] = key
            data["{#TOTAL}"] = value
            zbxout['data'].append(data)

        writeconf("/tmp/sockets.json",zbxout)


    if sys.argv[1] == "sender":
        result = getsockets()

        #print("Conexões locais:")
        #print(result['local'])

        #print("Conexões remotas:")
        #print(result['remote'])
